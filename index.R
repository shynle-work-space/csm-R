...
# split_result <- train_test_split(feature_1, "Genre_factor")
...
#     ncv_test_re <- ncvTest(model) #H0: phương sai sai số không đổi
...
# # 🔥🔥🔥 Manually choose the column to remove
# removed_col <- c()

# # 🔥🔥🔥 Manually choose the column to PCA
# removed_col <- c()
